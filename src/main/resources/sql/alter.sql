...
/*----------------2020.12.13---------------------*/
alter table `study`.`region` add latitude varchar(50) null comment '위도';
alter table `study`.`region` add longitude varchar(50) null comment '경도';
...
/*----------------2020.12.19---------------------*/
alter table `study`.`user` add subject_id bigint null comment '유저 관심 카테고리';